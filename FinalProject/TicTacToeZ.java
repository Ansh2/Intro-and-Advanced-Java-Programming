...
public class TicTacToeZ {
	...
	public static void finalchecker(char[][] board, char usersymbol, char computersymbol) { //Error here 
		if (checker(board) == false && (usersymbol == 'X')) {
			System.out.println("Congratulations, you've won!");
		} else if (checker(board) == false && (computersymbol == 'X')) {
			System.out.println("Sorry, try next time:(");
		} else if (checker(board) == false && usersymbol == 'O') {
			System.out.println("Congratulations, you've won!");
		} else if (checker(board) == false && computersymbol == 'O') {
			System.out.println("Sorry, try next time:(");
		} else {
